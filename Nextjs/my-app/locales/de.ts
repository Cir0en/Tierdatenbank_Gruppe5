...
const de = {
  ...
  settings: {
    ...
    english:         'Englisch',
    exportTitle:     'Export',
    exportDesc:      'Exportiere alle Sammlungsobjekte als CSV-Datei. Die Datei enthält Name, Status, Taxonomie, Fundort, Maße und weitere Felder.',
    exportBtn:       '⬇ CSV herunterladen',
    exportBtnBusy:   '⏳ Wird erstellt…',
    importTitle:     'Import',
    importDesc:      'Importiere Fundobjekte aus einer CSV-Datei (gleiches Spaltenformat wie der Export). Taxonomie, Sammlung und Fundort werden anhand des Namens wiederverwendet oder neu angelegt.',
    importBtn:       '⬆ CSV importieren',
    importBtnBusy:   '⏳ Wird importiert…',
